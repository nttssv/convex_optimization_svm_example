...
key. Tables generally use two-decimal displays, switching to scientific
notation or additional digits where numerical tolerances and repeated-seed
comparisons require them. Every numerical check and audit uses the stored
machine-precision values in the companion \path{output/csv/} files; several
artifacts also provide separate presentation-ready display columns.
